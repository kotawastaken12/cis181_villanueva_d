...
case "$PACKAGE_NAME" in
  lab_S1-2.zip) TARGET="lab1-2" ;;
  lab_S1-3.zip) TARGET="lab1-3" ;;
  lab_S1-4.zip) TARGET="lab1-4" ;;
  lab_S1-5.zip) TARGET="lab1-5" ;;
  lab_S2-1.zip) TARGET="lab2-1" ;;
  lab_S2-3.zip) TARGET="lab2-3" ;;
  lab_S2-5.zip) TARGET="lab2-5" ;;
  lab_S3-1.zip) TARGET="lab3-1" ;;
  lab_S3-3.zip) TARGET="lab3-3" ;;
  *)
    show_message "This is not a CIS181 starter package. Please choose a file named lab_Sx-y.zip."
    exit 1
    ;;
esac
